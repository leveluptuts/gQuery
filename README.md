...
The codegen will find the file and spit out a file next to it. Named `FileName.gq.ts`
...
From this, gQuery will generate a file named `AdminTags.gq.ts` That will contain the following
...
import type {
  GFetchReturnWithErrors,
  GGetParameters,
} from "@leveluptuts/g-query";
...
export type AdminTagsQuery = {
  ...
  tags?:
    | Array<
        { __typename?: "Tag"; _id: string; name: string } | null | undefined
      >
    | null
    | undefined;
};
